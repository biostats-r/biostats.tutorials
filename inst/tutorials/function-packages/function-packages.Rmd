...
description: Using functions and packages
...
Information on how to make a package using the `usethis` and `devtools` packages can be found in the package writing book or at [https://r-pkgs.org/whole-game.html](https://r-pkgs.org/whole-game.html). 
