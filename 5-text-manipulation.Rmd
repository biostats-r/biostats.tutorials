...
```{r eval = FALSE}
library("tidyverse")# load stringr, ggplot, dplyr etc
```
...
- `\W` matches anything that is not alphanumeric
...
One important difference is that if the match fails, `str_extract` will return `NA`, wereas `str_replace` will return the original string.
